...
const MOD_DESC_MAP = {
  Buck: 'Buck blitza pelo gap forte.', Will: 'Will blitza pelo gap fraco.',
  Mike: 'Mike blitza pelo gap A.', Fire: 'Fire: Will + Buck blitzam juntos.',
  WiM: 'WiM: Will + Mike blitzam juntos.', BuD: 'BuD: Buck + Dog blitzam pelo lado forte.',
  RoD: 'RoD: Rover + Dog blitzam pelo exterior.', Dog: 'Dog blitza pelo exterior.',
  Blood: 'Blood: combinação especial — confirmar com o coordenador.',
}
const COV_DESC_MAP = {
  Blue: 'Cover 2: dois safeties dividem o fundo em duas zonas.',
  Green: 'Cover 3: três zonas no fundo.', Orange: 'Cover 4: quatro zonas no fundo.',
